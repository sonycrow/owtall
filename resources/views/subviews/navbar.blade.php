        ...
        <nav id="sidebar"
            ...
            <div class="px-4 pb-6">
                ...
                <ul class="mb-8 text-sm font-medium">
                    ...
                    <li>
                        <a class="flex items-center rounded py-3 pl-3 pr-4 text-gray-800 hover:bg-gray-300" href="{{ url('locations') }}">
            ...
            <div class="px-4 pb-6">
                ...
                <ul class="mb-8 text-sm font-medium">
                    <li>
                        <a class="flex items-center rounded py-3 pl-3 pr-4 text-gray-800 hover:bg-gray-300" href="{{ url('units-builder') }}">
                            <span class="select-none">Units builder</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center rounded py-3 pl-3 pr-4 text-gray-800 hover:bg-gray-300" href="{{ url('locations-builder') }}">
