    ...
    <div x-data="{ imgModal: false, imgSrc: '' }">
        <template @lightbox.window="imgModal = true; imgSrc = $event.detail.src;" x-if="imgModal">
            <div x-transition:enter="transition ease-out duration-300"
                 ...
                 class="fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center bg-black bg-opacity-75">

                <div @click.away="imgModal = true" class="flex flex-col max-w-3xl max-h-full">
                    <div class="p-2">
                        <img :alt="imgSrc" class="object-contain h-screen p-10" :src="imgSrc"/>
